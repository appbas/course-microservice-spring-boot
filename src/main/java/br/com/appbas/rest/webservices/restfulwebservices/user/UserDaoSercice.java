...
public class UserDaoSercice {
	...
	static {
		...
		users.add(new User(++usersCount,"Augusto", LocalDate.now().minusYears(15)));
		users.add(new User(++usersCount,"Silva", LocalDate.now().minusYears(25)));
	}
